      ...
      <div className="Contents_Wrap">
        <div className="Footer_Inside">
          <div className="Project_Outline">
            ...
            <h3>💧 서비스 소개</h3>
            <p>
              "하.. 화장품 종류도 너무많고.. 대체 내 피부에 맞는 화장품은
              뭘사야되는거지?"
            </p>
            <p>고민하는 당신을 위한 최고의 솔루션, Lacier</p>
            <br />
            <p>
              남성들은 화장품을 살 때 대체 어떤걸 사야하는지 고민합니다.
              <br />
              우리는 그러한 고민을 해결해주고, 손쉽게 나의 피부타입에 알맞은
              제품을 찾을수 있도록 도와드립니다.
              <br />
              본인 피부에 어울리는 제품을 쉽게 찾기를 원하는 남성들을 위해
              Lacier 쇼핑몰 프로젝트가 시작되었습니다.
            </p>
            <br />
            <h2>기술 스택</h2>
            <h3>✔️Frond-end</h3>
          ...
          <div className="Footer_Members">
            ...
            <div className="Member_GitHub">
              <ul>
                ...
                <li className="Footer_Position">FrontEnd</li>
                <li>
                  <a href="https://github.com/limdumb">
                    https://github.com/limdumb
                  </a>
                </li>
                <li>
                  <a href="https://github.com/shim5505">
                    https://github.com/shim5505
                  </a>
                </li>
                <li>
                  <a href="https://github.com/rlawodn46465">
                    https://github.com/rlawodn46465
                  </a>
                </li>
                <li className="Footer_Position">BackEnd</li>
                <li>
                  <a href="https://github.com/jution113">
                    https://github.com/jution113
                  </a>
                </li>
                <li>
                  <a href="https://github.com/bum19">
                    https://github.com/bum19
                  </a>
                </li>
                <li>
                  <a href="https://github.com/woojcoding">
                    https://github.com/woojcoding
                  </a>
                </li>
              </ul>
            </div>
