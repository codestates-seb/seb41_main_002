...
const Rating = (props: RatingProps) => {
  ...
  return (
    <RatingBox
      ...
      size={props.ratingSetting.ratingSize}
    >
      <div className="Star_Ratings_Fill">
        <span onClick={() => { ratingClickEdit(1) }}>
          ★
        </span>
        <span onClick={() => { ratingClickEdit(2) }}>
          ★
        </span>
        <span onClick={() => { ratingClickEdit(3) }}>
          ★
        </span>
        <span onClick={() => { ratingClickEdit(4) }}>
          ★
        </span>
        <span onClick={() => { ratingClickEdit(5) }}>
          ★
        </span>
      </div>
